...
class ultrasonic_pub:
   ...
   def __init__(self):
      ...
      self.us_back_pub = rospy.Publisher('us_back', Range, queue_size=1)
      self.us_right_pub = rospy.Publisher('us_right', Range, queue_size=1)
      self.us_left_pub = rospy.Publisher('us_left', Range, queue_size=1)
      self.us_back_left_pub = rospy.Publisher('us_back_left', Range, queue_size=1)
      self.us_back_right_pub = rospy.Publisher('us_back_right', Range, queue_size=1)
   ...
   def send(self):
      ...
      us_parrent[2].header.frame_id = "ultrasonic_link_back"
      self.us_back_pub.publish(us_parrent[2])

      us_parrent[4].header.frame_id = "ultrasonic_link_right"
      self.us_right_pub.publish(us_parrent[4])

      us_parrent[0].header.frame_id = "ultrasonic_link_left"
      self.us_left_pub.publish(us_parrent[0])

      us_parrent[1].header.frame_id = "ultrasonic_link_back_left"
      self.us_back_left_pub.publish(us_parrent[1])

      us_parrent[3].header.frame_id = "ultrasonic_link_back_right"
      self.us_back_right_pub.publish(us_parrent[3])
